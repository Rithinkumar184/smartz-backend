...
// Attach a listener for server 'error' events to avoid uncaught exceptions
server.on('error', (err) => {
  if (err && err.code === 'EADDRINUSE') {
    console.error(`⚠️  Port ${PORT} is already in use. Please free the port or set a different PORT in your .env file.`);
    process.exit(1);
  }
